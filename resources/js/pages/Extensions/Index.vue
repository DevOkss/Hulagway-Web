...
import { FileDown, FileSpreadsheet, PlusCircle, Trash2 } from 'lucide-vue-next';
...
const breadcrumbs: BreadcrumbItemType[] = [{ title: 'Extension Activities', href: '/extensions' }];
...
const onYearChange = (e: Event) => {
    ...
    router.get('/extensions', v ? { year: v } : {}, { preserveState: true });
};
...
<template>
    <Head title="Extension Activities" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-4 p-4 sm:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="font-heading text-xl font-semibold sm:text-2xl">Extension Activities</h1>
                    <p class="text-sm text-neutral-500">Plan, track and document your program's activities.</p>
                </div>
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div v-if="canExport" class="ml-auto flex gap-2">
                    <Button variant="outline" size="sm" as-child class="gap-1.5"><a :href="exportUrl('pdf')"><FileDown class="size-4" /> PDF (all)</a></Button>
                    <Button size="sm" as-child class="gap-1.5 bg-brand-gradient text-white"><a :href="exportUrl('xlsx')"><FileSpreadsheet class="size-4" /> Excel (all)</a></Button>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-0.5 text-sm text-neutral-500">
                            {{ activity.program?.name ?? 'No program' }} · {{ activity.barangay?.name ?? 'City-wide' }}
                        </p>
            ...
            <div v-if="!activities.length" class="rounded-2xl border border-dashed border-brand-300 bg-brand-50 p-10 text-center text-sm text-brand-500">
                No extension activities yet.
            </div>
